  ...
  return (
    <>
      ...
      <section className="sidebar-section border-b-2">
        ...
        <SectionSubhead
          title="New condo address to create"
          icon={faAddressCard}
        />
...
const NewCondoAddress = ({ street, setStreet, parcel, building, setBuilding, setParcel, session, addresses, setAddresses, lngLat, setSelectableLayers }) => {
  ...
  return (
    <>
      {!parcel && <section className='sidebar-section'>
        <h2>Select the parent parcel of the new condo address.</h2>
      </section>}
      {parcel && <AssignmentParcel {...{ parcel, setAddresses, setModelAddress, setStreet, setBuilding }} />}
      {parcel && <NewAddressToSubmit {...{ street, parcel, setParcel, building, modelAddress, session }} />}
    </>
  )
}

export default NewCondoAddress;