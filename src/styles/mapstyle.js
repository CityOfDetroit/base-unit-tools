...
export const baseStyle = {
  ...
  sources: {
    ...
    baseunits: {
      ...
      "maxzoom": 23,
      "scheme": "xyz",
      "url": "https://tiles.arcgis.com/tiles/qvkbeam7Wirps6zC/arcgis/rest/services/BaseUnitVectorTiles2024/VectorTileServer",
      "tiles": [
        "https://tiles.arcgis.com/tiles/qvkbeam7Wirps6zC/arcgis/rest/services/BaseUnitVectorTiles2024/VectorTileServer/tile/{z}/{y}/{x}.pbf"
      ]
    },
    satellite: {
      type: "raster",
...
export const darkStyle = () => {
  ...
  // set land layers to a darker shade
  darkStyle.layers.forEach((l, i) => {

    const layers_to_exclude = [
      "Land/Not ice",
      "Urban area",
      "Land/Ice"
    ]

    if (layers_to_exclude.indexOf(l.id) > -1) {
      darkStyle.layers[i].paint["fill-color"] = {stops: [
        [0, "#113"],
        [10, "#113"],
        [15, "#113"],
      ]}
